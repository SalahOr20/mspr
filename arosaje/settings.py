"""
Django settings for arosaje project.
...
SECRET_KEY = 'django-insecure-v#&uk@-=gl$tfy!^u#==vr7@*@_%5$t@=g-hk*014&xl84+m6c'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=15),  # Augmentez selon vos besoins
